...
function buildLlmsFull() {
  ...
  var content = [
    ...
    '## Open Roles',
    '',
    'No roles are open right now. Future opportunities will be posted at https://www.baddecisions.studio/work-with-us/open-roles.',
    '',
    'General contact: create@baddecisions.studio',
    '',
    '## Connected sites',
    '',
